...
import { apiService, GameState, PolicyProposal, ProposalSubmission } from '../services/api';
...
interface GameContextType {
  ...
  playTurn: (proposal: ProposalSubmission) => Promise<void>;
}
...
type GameAction =
  ...
  | { type: 'SET_SUGGESTIONS'; payload: PolicyProposal[] }
  | { type: 'CLEAR_ERROR' }
  | { type: 'RESET_GAME' }
...
// Reducer function
function gameReducer(state: GameStateContext, action: GameAction): GameStateContext {
  switch (action.type) {
    case 'SET_LOADING':
